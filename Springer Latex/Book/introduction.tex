...
%TODO: Confirm abstract type (* or no *) and if there should be an abstract to the introduction
...
%TODO: Should the abstract below be include here? or somewhere else
