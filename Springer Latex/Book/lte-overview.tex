...
\begin{figure}[!ht] 
	\centering
	\subfloat[OFMDA used in downlink.]{\includegraphics[width=5in]{figures3/lte-ofdma}%
		\label{ofdma}}
	\\
	\subfloat[SC-FDMA used in uplink.]{\includegraphics[width=5in]{figures3/lte-scdma}%
		\label{sc-fdma}}
...
\label{lte-mac}
In LTE-A, two distinct MAC layers are defined for the UE and the eNB, owing to the different functions
