...
\begin{figure}[!ht] 
	\centering
	\subfloat[OFMDA used in downlink.]{\includegraphics[width=4in]{figures3/lte-ofdma}%
		\label{ofdma}}
	\\
	\subfloat[SC-FDMA used in uplink.]{\includegraphics[width=4in]{figures3/lte-scdma}%
		\label{sc-fdma}}
